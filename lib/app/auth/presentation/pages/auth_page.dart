...
class _AuthPageForm extends StatefulWidget {
  const _AuthPageForm({
    Key? key,
  }) : super(key: key);
...
class _AuthPageFormState extends State<_AuthPageForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<AuthPageProvider, bool>(
      ...
      child: _AuthPageEmailPasswordTextFields(
